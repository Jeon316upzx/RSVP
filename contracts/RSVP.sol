...
contract RSVP {
    ...
    mapping(bytes32 => EventI) public idToEvent;

    function createNewEventI(
        uint256 eventTimestamp,
        uint256 deposit,
        uint256 maxCapacity,
    ...
    function createRSVPS(bytes32 eventId) external payable {
        EventI storage myEvent = idToEvent[eventId];
    ...
    function confirmAllAttendees(bytes32 eventId) external {
        ...
        EventI memory myEvent = idToEvent[eventId];
